...
import { House, FolderOpen, CircleCheck, MessageSquareText, ChartNoAxesCombined, Mail, Globe, Settings, CircleUser } from "lucide-react";
...
const Footer = () => {
  const { openDocs, openAgent, toggleDocs, toggleAgent, focusWindow } = useWindowManager();
  ...
  return (
    <footer className="m-2 bg-[#08182b] px-4 py-1.5 text-[#4a6a8a] flex self-center justify-between items-center rounded-xl border border-[#1e3a5a] shadow-[0_0_20px_rgba(14,30,55,0.6)]">
      ...
      <div className="flex justify-center items-center gap-3">
        ...
        {/* Home — also brings kanban to top */}
        <NavLink
          to="/"
      ...
      <div className="flex pl-5 justify-center items-center gap-4">
        <div className="flex flex-col items-end">
          <div className="text-xs font-semibold text-[#7a9ab5]">14:22</div>
          <div className="text-[10px] text-[#3a5570]">12/05/2024</div>
        </div>
